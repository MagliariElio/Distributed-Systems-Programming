      ...
      <Table striped bordered hover responsive className="mb-4">
        <thead className="thead-dark">
          <tr>
            ...
            <th className='text-center'>Activated By</th>
          ...
          {props.films.length === 0 ? (
            ...
            props.films.map((film) =>
              <PublicFilmRow
                ...
                user={props.user} filmSelections={props.filmSelections}
              />
            )
          )}
        </tbody>
...
function PublicFilmRow(props) {
  ...
  for (let i = 0; i < props.filmSelections.length; i++) {
    if (props.filmSelections[i].filmId == props.id && props.filmSelections[i].status === MqttStatusMessageEnum.ACTIVE) {
      assignedUser = props.filmSelections[i].userName;
    }
  }

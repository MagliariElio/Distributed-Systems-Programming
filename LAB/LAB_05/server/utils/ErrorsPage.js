...
function formatErrorFilmAlreadyActive(loggedUserId, filmId) {
  return `The film (ID: ${filmId}) is already active for the reviewer (ID: ${loggedUserId}). Please check your active reviews or ensure no duplicate actions are being performed.`;
}

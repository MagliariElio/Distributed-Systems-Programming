...
const MqttUtils = require('./utils/Mqtt.js');
...
var apifilmspublicfilmIdselectionController = require('./controllers/ApifilmspublicfilmIdselection.js');
...
app.patch('/api/films/public/:filmId/selection', isLoggedIn, apifilmspublicfilmIdselectionController.patchFilmActiveSelection);

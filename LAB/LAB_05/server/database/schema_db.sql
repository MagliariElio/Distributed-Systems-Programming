...
CREATE TABLE
	"image_formats" ("imageId" INTEGER NOT NULL, "mimetype" TEXT NOT NULL, PRIMARY KEY ("imageId", "mimetype"), FOREIGN KEY ("imageId") REFERENCES "images" ("id") ON DELETE CASCADE);
...
INSERT INTO
	"reviews" ("filmId", "reviewerId", "completed", "reviewDate", "rating", "reviewText", "active")
VALUES
	(2, 5, 1, '2022-03-04', 10, 'This film is a perfect conclusion for the trilogy.', 0),
	(3, 4, 1, '2022-01-23', 9, 'I appreciated the plot twists, but I did not understand so much the ending. I am eagerly waiting for the sequel.', 0),
	(3, 2, 1, '2022-04-04', 8, 'I would have preferred that this film did not adopt the widescreen cinema standard resolution.', 0),
	(2, 2, 1, '2022-04-04', 10, 'I could not stop watching until the very end. However, you must watch the prequels before this film to really understand it.', 0),
	(7, 5, 1, '2022-03-04', 7, 'The ending feels rushed and it should have better explained the life decisions of the characters.', 0),
	(9, 5, 1, '2022-04-04', 9, 'Even if the film is short, it provides a deep characterizaition for the two main characters.', 0),
	(9, 1, 0, NULL, NULL, NULL, 1),
	(2, 3, 0, NULL, NULL, NULL, 1),
	(4, 5, 0, NULL, NULL, NULL, 1),
	(5, 4, 0, NULL, NULL, NULL, 1),
	(10, 1, 0, NULL, NULL, NULL, 0),
	(7, 1, 0, NULL, NULL, NULL, 0);

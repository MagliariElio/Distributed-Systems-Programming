...
const { MqttStatusMessageEnum, publishFilmMessageMqtt } = require('../utils/Mqtt');
...
exports.deleteSinglePublicFilm = async function (filmId, loggedUserId) {
  try {
    ...
    const message = new MqttFilmMessage(MqttStatusMessageEnum.DELETED, null, null);
    publishFilmMessageMqtt(filmId, message);

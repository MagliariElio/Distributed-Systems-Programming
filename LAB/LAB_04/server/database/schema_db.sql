...
VALUES
	(2, 5, 1, '2022-03-04', 10, 'This film is a perfect conclusion for the trilogy.', 1),
	(3, 4, 1, '2022-01-23', 9, 'I appreciated the plot twists, but I did not understand so much the ending. I am eagerly waiting for the sequel.', 1),
	(3, 2, 1, '2022-04-04', 8, 'I would have preferred that this film did not adopt the widescreen cinema standard resolution.', 1),
	(2, 2, 1, '2022-04-04', 10, 'I could not stop watching until the very end. However, you must watch the prequels before this film to really understand it.', 1),
	(7, 5, 1, '2022-03-04', 7, 'The ending feels rushed and it should have better explained the life decisions of the characters.', 1),
	(9, 5, 1, '2022-04-04', 9, 'Even if the film is short, it provides a deep characterizaition for the two main characters.', 1),
	(9, 1, 0, NULL, NULL, NULL, 0),
	(2, 1, 0, NULL, NULL, NULL, 0),
	(4, 1, 0, NULL, NULL, NULL, 0),
	(5, 1, 0, NULL, NULL, NULL, 0),

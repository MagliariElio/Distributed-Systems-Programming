...
INSERT INTO "films" ("id","title","owner","private","watchDate","rating","favorite") VALUES (1,'Your Name',1,1,'2021-10-03',9,1),
 ...
 (5,'Aria of a Starless Night',3,1,'2022-07-20',8,0),
 (6,'Spirited Away',5,0,NULL,NULL,NULL),
 (7,'5 Centimeters Per Second',5,0,NULL,NULL,NULL),
 (8,'Nausicaa',5,1,'2020-03-15',9,0),
 (9,'The Garden of Words',1,0,NULL,NULL,NULL),
 (10,'Paradox Spiral',4,1,'2021-12-26',10,1);

INSERT INTO "reviews" ("filmId","reviewerId","completed","reviewDate","rating","review") VALUES (2,5,1,'2022-03-04',10,'This film is a perfect conclusion for the trilogy.'),
 (3,1,1,'2022-01-23',9,'I appreciated the plot twists, but I did not understand so much the ending. I am eagerly waiting for the sequel.'),
 (4,1,0,'2020-01-01',NULL,NULL),
